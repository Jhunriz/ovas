                ...
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="number" maxlength="11" class="form-control form-control-sm form-control-border" id="contact" name="contact" required placeholder="xxxxxxxxxxxxx">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-dark rounded-pill col-5">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
